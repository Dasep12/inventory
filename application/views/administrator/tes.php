			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
						...
						<ul class="submenu">
							<li class="">
								...
								<ul class="submenu">
									...
									<li class="">
										<a href="<?= base_url() ?>/mobile-menu-3.html">
											<i class="menu-icon fa fa-caret-right"></i>
											Mobile Menu 3
										</a>
							...
							<li class="">
								<a href="<?= base_url() ?>/jquery-ui.html">
									<i class="menu-icon fa fa-caret-right"></i>
									jQuery UI
								</a>
							...
							<li class="">
								<a href="<?= base_url() ?>/nestable-list.html">
									<i class="menu-icon fa fa-caret-right"></i>
									Nestable Lists
								</a>
					...
					<li class="active open">
						...
						<ul class="submenu">
							<li class="active">
								<a href="<?= base_url() ?>/form-elements.html">
									<i class="menu-icon fa fa-caret-right"></i>
									Form Elements
								</a>
							...
							<li class="">
								<a href="<?= base_url() ?>/form-elements-2.html">
									<i class="menu-icon fa fa-caret-right"></i>
									Form Elements 2
								</a>
							...
							<li class="">
								<a href="<?= base_url() ?>/form-wizard.html">
									<i class="menu-icon fa fa-caret-right"></i>
									Wizard &amp; Validation
								</a>
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="<?= base_url() ?>/error-404.html">
									<i class="menu-icon fa fa-caret-right"></i>
									Error 404
								</a>
							...
							<li class="">
								<a href="<?= base_url() ?>/error-500.html">
									<i class="menu-icon fa fa-caret-right"></i>
									Error 500
								</a>
											...
											<div class="widget-box">
												<div class="widget-header">
													...
													<span class="widget-toolbar">
														<a href="<?= base_url() ?>/#" data-action="settings">
															<i class="ace-icon fa fa-cog"></i>
														</a>

														<a href="<?= base_url() ?>/#" data-action="reload">
															<i class="ace-icon fa fa-refresh"></i>
														</a>

														<a href="<?= base_url() ?>/#" data-action="collapse">
															<i class="ace-icon fa fa-chevron-up"></i>
														</a>

														<a href="<?= base_url() ?>/#" data-action="close">
