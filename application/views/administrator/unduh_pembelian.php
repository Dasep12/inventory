...
<div id="form-report" >
     ...
     <hr>
		...
		<form onsubmit="return validasi()" class="form-horizontal" action="<?= base_url("administrator/Unduh/downloadPembelian") ?>" method="post" id="" role="form">
		<div class="col-lg-6">
			<table class="table">
				<tr>
					<td>Nama Barang</td>
