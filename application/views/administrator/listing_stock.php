<div class="page-header">
	<h1>Review Lajur Stock Barang</h1>
</div><!-- /.page-header -->
...
<div class="row">
	<div class="col-xs-12">
     ...
     <hr>
		...
		<form onsubmit="return validasi()" class="form-horizontal" action="<?= base_url("administrator/Laporan/report") ?>" method="post" id="" role="form">
		<div class="col-lg-6">
			<table class="table">
				<tr>
					<td>Nama Barang</td>
